        ...
        <form action="<?php echo e($promotion ? route('host.promotions.update', $promotion) : route('host.promotions.store')); ?>" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-12">
                    ...
                    <input type="date" id="start_date" name="start_date" class="form-control" min="<?php echo e(now()->toDateString()); ?>" value="<?php echo e(old('start_date', $promotion?->start_date?->format('Y-m-d'))); ?>" required>

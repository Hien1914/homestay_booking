                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if($item->thumbnail_url): ?>
                                        <img src="<?php echo e(asset('storage/' . $item->thumbnail_url)); ?>" alt="<?php echo e($item->title); ?>"
                                ...
                                <td>
                                    <div class="fw-bold text-dark"><?php echo e($item->title); ?></div>
                                </td>
                                <td style="max-width: 400px;">
                                    <?php if($item->description): ?>
                                        <div class="small text-muted text-truncate" title="<?php echo e($item->description); ?>">
                                ...
                                <td>
                                    <div class="d-flex justify-content-center gap-1">
                                        <a href="<?php echo e(route('admin.posts.edit', $item->id)); ?>" class="admin-action-btn"
                                            title="Chỉnh sửa">

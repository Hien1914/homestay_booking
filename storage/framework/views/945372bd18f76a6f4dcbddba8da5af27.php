...
<link rel="stylesheet" href="<?php echo e(asset('css/clients/about.css')); ?>">
    ...
    <section class="about-cta-section py-5">
        <div class="container container-setting">
            <div class="about-cta-box text-center p-5 bg-success text-white rounded-4 shadow">
                ...
                <a href="<?php echo e(route('pages.search')); ?>" class="btn btn-light btn-lg rounded-pill px-4 fw-bold">
...
<?php echo $__env->make('clients.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Study\KLTN\homestay_booking\resources\views/clients/pages/about.blade.php ENDPATH**/ ?>
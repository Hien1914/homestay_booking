...
<?php $__env->startSection('title', 'Điều khoản dịch vụ'); ?>
    ...
    <div class="container-setting policy-container">
        ...
        <div class="policy-content">
            ...
            <div class="policy-section">
                ...
                <p>Thông tin người dùng được thu thập và bảo vệ theo <a href="<?php echo e(route('pages.privacy_policy')); ?>" class="fw-bold text-decoration-none">Chính sách bảo mật</a> của chúng tôi.</p>
            </div>
...
<?php echo $__env->make('clients.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Study\KLTN\homestay_booking\resources\views/clients/pages/terms.blade.php ENDPATH**/ ?>
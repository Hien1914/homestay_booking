...
<div class="admin-page-header mb-4">
    <div class="admin-page-header-content">
        ...
        <p class="admin-page-subtitle text-muted small mb-0">Theo dõi số liệu tổng hợp và hoạt động mới nhất của hệ thống.</p>
    </div>
</div>
    ...
    <div class="card-body p-4">
        <form method="GET" action="<?php echo e(route('admin.dashboard')); ?>" class="row g-3 align-items-end">
            <div class="col-md-4">
                ...
                <input type="date" id="dashboard_from_date" name="from_date" class="form-control border-light-subtle" value="<?php echo e($fromDate); ?>">
            </div>
            <div class="col-md-4">
                <label for="dashboard_to_date" class="form-label small fw-bold text-secondary">Đến ngày</label>
                <input type="date" id="dashboard_to_date" name="to_date" class="form-control border-light-subtle" value="<?php echo e($toDate); ?>">
            </div>
        ...
        <div class="card border-0 shadow-sm h-100 rounded-3 overflow-hidden">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex flex-wrap gap-3 justify-content-center small mt-4">
                    <span><span class="admin-dot d-inline-block me-1 rounded-circle" style="background:#1d4ed8; width:10px; height:10px;"></span>Doanh thu</span>
                    <span><span class="admin-dot d-inline-block me-1 rounded-circle" style="background:#f97316; width:10px; height:10px;"></span>Lượng đặt phòng</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm h-100 rounded-3 overflow-hidden">
            <div class="card-header bg-white py-3 border-light-subtle d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.homestays')); ?>" class="btn btn-sm btn-outline-success rounded-pill px-3 fw-semibold">Xem tất cả</a>
            </div>
                    ...
                    <table class="admin-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recentHomestays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $homestay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="fw-bold text-dark small text-truncate" style="max-width: 200px;"><?php echo e($homestay->title); ?></div>
                                    </td>
                                    <td>
                                        <span class="badge bg-light text-dark border small fw-medium"><?php echo e($homestay->room_code); ?></span>
                                    </td>
                                    <td>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="4" class="text-center text-muted py-5 small">Chưa có dữ liệu.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm h-100 rounded-3 overflow-hidden">
            <div class="card-header bg-white py-3 border-light-subtle d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-sm btn-outline-success rounded-pill px-3 fw-semibold">Xem tất cả</a>
            </div>
            <div class="card-body p-0">
                <div class="admin-table-wrap">
                    <table class="admin-table">
                        ...
                        <tbody>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr><td colspan="3" class="text-center text-muted py-5 small">Chưa có dữ liệu.</td></tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
                </div>
            ...
            <table class="admin-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $popularHomestays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $homestay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <span class="badge <?php echo e($index == 0 ? 'bg-warning' : ($index == 1 ? 'bg-secondary-subtle text-secondary' : ($index == 2 ? 'bg-danger-subtle text-danger' : 'bg-light text-muted'))); ?> rounded-circle d-flex align-items-center justify-content-center mx-auto" style="width: 24px; height: 24px; font-size: 10px;"><?php echo e($index + 1); ?></span>
                            </td>
                            <td>
                            ...
                            <td>
                                <span class="admin-badge admin-badge-success"><?php echo e(number_format($homestay->bookings_count)); ?></span>
                            </td>
                            <td>
                                <span class="admin-badge admin-badge-danger"><?php echo e(number_format($homestay->favorites_count)); ?></span>
                            </td>
                            <td>
                                <div class="text-warning small fw-bold">
                                    <i class="bi bi-star-fill me-1"></i><?php echo e(number_format((float) ($homestay->reviews_avg_rating ?? 0), 1)); ?>

                                </div>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr><td colspan="6" class="text-center text-muted py-5 small">Chưa có dữ liệu.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </div>

    ...
    <div class="card-body p-0">
        <div class="admin-table-wrap">
            <table class="admin-table">
                ...
                <tbody>
                    <?php $__empty_1 = true;
                    $__currentLoopData = $applications;
                    $__env->addLoop($__currentLoopData);
                    foreach ($__currentLoopData as $app):
                            ...
                            <td>
                                <?php if ($app->status === \App\Models\HostApplication::STATUS_PENDING): ?>
                                    <div class="d-flex justify-content-center gap-1">
                                        <form action="<?php echo e(route('admin.host-applications.approve', $app->id)); ?>"
                                        ...
                                        <form action="<?php echo e(route('admin.host-applications.reject', $app->id)); ?>"
                                            method="POST" class="d-inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>

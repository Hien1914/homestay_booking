            ...
            <table class="admin-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $amenities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $amenity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="ps-4"><span class="admin-id-badge">#<?php echo e($loop->iteration); ?></span></td>
                            <td><div class="fw-bold text-dark"><?php echo e($amenity->name); ?></div></td>
                            ...
                            <td class="text-center small text-muted"><?php echo e($amenity->created_at->format('d/m/Y')); ?></td>
                            <td class="text-center">
...
<?php echo $__env->make('host.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Study\KLTN\homestay_booking\resources\views/host/amenities.blade.php ENDPATH**/ ?>
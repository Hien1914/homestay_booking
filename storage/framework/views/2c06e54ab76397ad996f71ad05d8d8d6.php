        ...
        <div class="card border-0 shadow-sm mb-4 rounded-4 overflow-hidden">
            ...
            <div class="card-body p-4">
                <div class="mb-5">
                    ...
                    <input type="file" id="cover_image" name="cover_image" class="form-control rounded-3" accept="image/*" <?php echo e(!$isEdit ? 'required' : ''); ?>>
                    <div class="admin-image-preview-flex mt-3 d-flex flex-wrap gap-3">
                        <div class="admin-image-item position-relative rounded-3 overflow-hidden shadow-sm border d-flex justify-content-center align-items-center" id="cover-preview" <?php echo $isEdit && $primaryImage ? 'style="display:flex;"' : 'style="display:none;"'; ?>>
                            <img <?php if($primaryImage): ?> src="<?php echo e(asset('storage/' . $primaryImage->image_url)); ?>" <?php endif; ?> alt="Preview" id="cover-preview-image" class="object-fit-contain" style="height: 120px; width: auto; max-width: 200px; display: block;<?php echo e($primaryImage ? '' : 'display:none;'); ?>">
                            <button type="button" id="cover-delete-btn" class="admin-image-delete btn btn-danger btn-sm rounded-circle shadow position-absolute" style="top:5px; right:5px;<?php echo e($primaryImage ? '' : 'display:none;'); ?>" onclick="removeCoverPreview(event)">
                                <i class="bi bi-x"></i>
                            </button>
                        </div>
                    </div>

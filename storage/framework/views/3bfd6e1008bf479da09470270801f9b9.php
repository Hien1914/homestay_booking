...
<style>
  @import url('<?php echo e(asset('css/clients/home.css')); ?>');
</style>
...
<section class="hero-section position-relative">
  <div class="hero-bg-slider position-absolute top-0 start-0 w-100 h-100">
    <div class="hero-slide active position-absolute top-0 start-0 w-100 h-100">
      <img src="<?php echo e(asset('img/hero1.jpg')); ?>" class="w-100 h-100 object-fit-cover" alt="Hero 1">
    </div>
    <div class="hero-slide position-absolute top-0 start-0 w-100 h-100">
      <img src="<?php echo e(asset('img/hero2.webp')); ?>" class="w-100 h-100 object-fit-cover" alt="Hero 2">
    </div>
    <div class="hero-slide position-absolute top-0 start-0 w-100 h-100">
      <img src="<?php echo e(asset('img/hero3.jpg')); ?>" class="w-100 h-100 object-fit-cover" alt="Hero 3">
    </div>
    <div class="hero-slide position-absolute top-0 start-0 w-100 h-100">
      <img src="<?php echo e(asset('img/hero4.jpg')); ?>" class="w-100 h-100 object-fit-cover" alt="Hero 4">
    </div>
  </div>
...
<section class="container-setting py-5">
    <div class="row g-5 g-lg-5 align-items-center">
      <div class="col-lg-6">
        <img src="<?php echo e(asset('img/anh_about.png')); ?>" alt="NestAway trải nghiệm homestay" class="about-img-main w-100" width="700" height="875" loading="lazy">
      </div>
        ...
        <ul class="about-features list-unstyled mb-4">
          <li class="about-feat">
            <span class="about-feat-icon" aria-hidden="true">
              <img src="<?php echo e(asset('img/icon/khoa.svg')); ?>" alt="" width="24" height="28">
            </span>
          ...
          <li class="about-feat">
            <span class="about-feat-icon" aria-hidden="true">
              <img src="<?php echo e(asset('img/icon/done.svg')); ?>" alt="" width="33" height="33">
            </span>
            <div class="about-feat-body">
          ...
          <li class="about-feat">
            <span class="about-feat-icon" aria-hidden="true">
              <img src="<?php echo e(asset('img/icon/hotro.svg')); ?>" alt="" width="24" height="24">
            </span>
            <div class="about-feat-body">
...
<?php echo $__env->make('clients.layout.partials.destination-carousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php echo $__env->make('clients.layout.partials.homestay-carousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('clients.layout.partials.testimonial-carousel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<section class="container-setting py-5 bg-white text-black text-center">
    ...
    <a href="<?php echo e(route('pages.search')); ?>" class="btn btn-success btn-lg rounded-pill px-5 fw-semibold shadow-sm">Tìm homestay ngay →</a>
</section>
...
<?php echo $__env->make('clients.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Study\KLTN\homestay_booking\resources\views/clients/home.blade.php ENDPATH**/ ?>
                    ...
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form action="<?php echo e(route('apply-host.store')); ?>" method="POST">
                            ...
                            <div class="form-note">
                                ...
                                <a href="<?php echo e(route('pages.terms')); ?>" class="fw-bold text-decoration-none">Điều khoản dịch vụ</a> và 
                                <a href="<?php echo e(route('pages.privacy_policy')); ?>" class="fw-bold text-decoration-none">Chính sách bảo mật</a> 

...
<section class="py-5">
  <div class="container-setting">
    <div class="d-flex justify-content-between align-items-center mb-4">
      ...
      <a href="<?php echo e(route('pages.search')); ?>" class="text-decoration-none fw-semibold" style="color: var(--green-900);">Xem thêm</a>
    </div>
    <div class="row g-4">
      <?php $__currentLoopData = $related; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col-12 col-md-6 col-lg-4">
          <a href="<?php echo e(route('homestay.show', ['slug' => $item->slug])); ?>" class="text-decoration-none text-dark d-block h-100">
            <article class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden">
              <div style="height: 200px; overflow: hidden;">
                <?php if($coverImage): ?>
                  <img
                    src="<?php echo e(asset('storage/' . $coverImage)); ?>"
              ...
              <div class="card-body d-flex flex-column gap-3 p-4">
                ...
                <p class="text-muted small mb-0"><?php echo e(\Illuminate\Support\Str::limit($item->description, 100)); ?></p>
                <div class="d-flex align-items-center justify-content-between mt-auto">
                  <div class="small text-warning fw-semibold">
                    <i class="fa-solid fa-star me-1"></i><?php echo e(number_format((float) ($item->reviews_avg_rating ?? 0), 1, ',', '.')); ?>

                    <span class="text-muted">(<?php echo e((int) ($item->reviews_count ?? 0)); ?>)</span>
                  </div>
                  <div class="fw-bold" style="color: #14532d;">
                    <?php echo e(number_format((int) $item->discounted_price, 0, ',', '.')); ?>đ
...
<?php echo $__env->make('clients.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Study\KLTN\homestay_booking\resources\views/clients/homestay-detail.blade.php ENDPATH**/ ?>
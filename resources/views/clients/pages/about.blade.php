...
<div class="about-page-wrapper">
    ...
    <section class="about-hero py-5">
        <div class="container container-setting">
            <div class="row align-items-center g-5">
                <div class="col-lg-7 about-hero-text">
                ...
                <div class="col-lg-5 about-hero-image">
    ...
    <section class="about-mission-vision py-5">
        <div class="container container-setting">
            <div class="row g-4">
                <div class="col-md-6">
                    <div class="mission-vision-card h-100 p-4 border rounded shadow-sm text-center">
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6">
                    <div class="value-item p-4 text-center">
                        <div class="value-icon mb-3 text-danger">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="value-item p-4 text-center">
                        <div class="value-icon mb-3 text-info">
    ...
    <section class="about-cta-section py-5">
        <div class="container container-setting">
            <div class="about-cta-box text-center p-5 bg-success text-white rounded-5 shadow">
